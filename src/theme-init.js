try {
  ...
  if (hasIdbBg || (bgMode === '"random"' || bgMode === '"freeze"')) {
    ...
    // Don't forcibly remove background-image here — it can hide a valid saved/bg image.
    preloader.textContent = "body { background-color: " + pColor + " !important; transition: none !important; }";
